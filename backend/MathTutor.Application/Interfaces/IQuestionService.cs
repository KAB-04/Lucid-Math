...
public interface IQuestionService
{
    ...
    Task<(bool Success, string Message, QuestionDto? Data)> CreateAsync(CreateQuestionDto dto);
    Task<(bool Success, string Message, QuestionDto? Data)> UpdateAsync(int id, UpdateQuestionDto dto);
